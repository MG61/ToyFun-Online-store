...
import static com.example.babystore.RecyclerAllProduct.MyDataBase.TABLE_NAME7;
...
public class Categories6 extends AppCompatActivity {
    ...
    private void displayData() {
        ...
        Cursor cursor = sqLiteDatabase.rawQuery("SELECT * FROM " + TABLE_NAME7 +"", null);
